...
qpoints, tbbandsperline, labels, ticks = readbulkekgnu('examples/AgP2/bulkek')

tbbandsperline *= thztomev



plt.figure(figsize=(6,2.5), dpi=300, layout='constrained')
topocolors = 'k'*80 + 'g' +'r'+'g'+'r'+'k'*2+'k'+'b'*3+'b'*3
...
plt.ylabel("Frequency (ThZ)", fontsize=10 )#(cm$^{-1}$)")
...
#plt.ylim(0, )
#plt.savefig("images/AgP2bulkek.png", format='png')
plt.show()