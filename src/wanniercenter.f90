...
subroutine  wannier_center3D_plane_mirror
   ...
   if (cpuid==0) then
      ...
      write(outfileindex, '(a)')"set output 'wcc-mirrorchernnumber.png'"
...
subroutine  wannier_center2D
   ...
   if (cpuid==0) then
      ...
      write(outfileindex,*) 'set terminal png truecolor enhanced', &
           ' font ", 60" size 1920, 1680'
      write(outfileindex,*) "set output 'wcc_slab.png'"
      ...
      write(outfileindex, '(a, i5, a)')"plot for [i=3: ", nfill+2, "] 'wcc_slab.dat' u 1:i w p  pt 7 lw 10 ps 1.1 lc 'red'"
      close(outfileindex)
   endif
...
!~    call  w3d_shell(K3D_start, K3D_vec1, K3D_vec2, Num_wann, wcc)
   ...
   if (cpuid==0) then
      ...
      write(outfileindex, '(3a)')'set terminal png truecolor enhanced', &
           ' font ", 60" size 1920, 1680'
      write(outfileindex, '(a)')"set output 'wcc.png'"
      write(outfileindex, '(a)')'unset key '
      write(outfileindex, '(a)')'set border lw 3 '
      write(outfileindex, '(a)')'set xtics offset 0, 0.2'
      write(outfileindex, '(a)')'set xtics format "%4.1f" nomirror out '
      ...
      write(outfileindex, '(a, i5, 3a)')" for [i=4: ", NumberofSelectedOccupiedBands+3, "] 'wcc.dat' u 1:i w p  pt 7 lw 10 ps 1.1 lc 'red'"
      close(outfileindex)
   endif
...
subroutine  wannier_center3D_nodalline
   ...
   do i=1, Num_NLs
      ...
      if (i<10) then
         write(epsfilename, '(a,i1,a)')'wanniercenter3D_NL_', i, '.png'
      elseif (i>=10.and.i<100) then
         write(epsfilename, '(a,i2,a)')'wanniercenter3D_NL_', i, '.png'
      elseif (i>=100.and.i<1000) then
         write(epsfilename, '(a,i3,a)')'wanniercenter3D_NL_', i, '.png'
      elseif (i>=1000.and.i<10000) then
         write(epsfilename, '(a,i4,a)')'wanniercenter3D_NL_', i, '.png'
      endif
...
subroutine  wannier_center3D_weyl
   ...
   do i=1, Num_Weyls
      ...
      if (i<10) then
         write(epsfilename, '(a,i1,a)')'wanniercenter3D_Weyl_', i, '.png'
      elseif (i>=10.and.i<100) then
         write(epsfilename, '(a,i2,a)')'wanniercenter3D_Weyl_', i, '.png'
      elseif (i>=100.and.i<1000) then
         write(epsfilename, '(a,i3,a)')'wanniercenter3D_Weyl_', i, '.png'
      elseif (i>=1000.and.i<10000) then
         write(epsfilename, '(a,i4,a)')'wanniercenter3D_Weyl_', i, '.png'
      endif
...
subroutine  Chern_3D
   ...
   if (cpuid==0) then
      ...
      write(outfileindex,'(3a)')' set terminal png truecolor enhanced', &
           ' font ", 60" size 1920, 1680'
      write(outfileindex,'(a)')' set output "wanniercenter3D_Chern.png"'
...
subroutine  Z2_3D
   ...
   if (cpuid==0) then
      ...
      write(outfileindex,'(3a)')'set terminal png truecolor enhanced', &
           ' font ", 60" size 1920, 1680'
      write(outfileindex,'(a)')' set output "wanniercenter3D_Z2.png"'
      write(outfileindex,'(a)')' set size 0.6,1.0'
      write(outfileindex,'(a)')' set multiplot '
      write(outfileindex,'(a)')' unset key '
      write(outfileindex,'(a)')' set border lw 1 '
